...
import { banners, womenProducts, cardImages } from '../assets/images';
...
function Women() {
  ...
  const filterCategories = [
    { id: 'category', name: 'Category', count: 10, selected: 5 },
    { id: 'color', name: 'Color', count: 12, selected: 6 },
    { id: 'price', name: 'Price', count: 8, selected: 4 },
    { id: 'size', name: 'Size', count: 14, selected: 7 },
    { id: 'fit', name: 'Fit', count: 6, selected: 3 },
  ];
            ...
            <div className="space-y-4">
              {activeFilter === 'category' && (
                <>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Dresses (18)</span>
                  ...
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Tops (15)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Bottoms (12)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Outerwear (8)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
              {activeFilter === 'color' && (
                <>
                  ...
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">White (10)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Pink (8)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Red (6)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
              {activeFilter === 'price' && (
                <div className="space-y-4">
                  ...
                  <div className="text-lg font-medium text-[var(--text-primary)]">₹0 - ₹4000</div>
              ...
              {activeFilter === 'size' && (
                <>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">XS (6)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">S (12)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">M (18)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">L (14)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">XL (8)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
              {activeFilter === 'fit' && (
                <>
                  ...
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Slim (15)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Loose (10)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
  ...
  return (
    <div className="justify-center items-center py-4 px-4 sm:px-6 lg:px-8 bg-[var(--bg-primary)]">
      ...
      <div className="md:hidden mb-4">
        <h1 className="text-xl font-bold text-[var(--text-primary)]">WOMEN'S FASHION</h1>
      </div>
            ...
            <div className="hidden md:flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 space-y-4 sm:space-y-0">
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`p-2 rounded border border-[var(--border-light)] transition-colors ${viewMode === 'grid' ? 'bg-[var(--accent-color)] text-[var(--text-inverse)]' : 'bg-[var(--bg-secondary)] text-[var(--text-primary)] hover:bg-[var(--accent-light)]'}`}
                >
                  <Grid className="w-4 h-4" />
                </button>
                <button
                  onClick={() => setViewMode('list')}
                  className={`p-2 rounded border border-[var(--border-light)] transition-colors ${viewMode === 'list' ? 'bg-[var(--accent-color)] text-[var(--text-inverse)]' : 'bg-[var(--bg-secondary)] text-[var(--text-primary)] hover:bg-[var(--accent-light)]'}`}
                >
              ...
              <div className="flex items-center space-x-2 w-full sm:w-auto">
                ...
                <select
                  ...
                  className="text-sm border border-[var(--border-light)] rounded px-3 py-1 focus:outline-none focus:border-[var(--accent-color)] w-full sm:w-auto bg-[var(--bg-primary)] text-[var(--text-primary)]"
                >
