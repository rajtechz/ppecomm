...
import { X, Trash2, Minus, Plus, Clock, Gift, Truck, Shield, RotateCcw } from "lucide-react";
...
const CartDrawer = ({ isOpen, onClose, cartItems }) => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 w-full max-w-2xl h-full bg-white shadow-2xl z-50 transform transition-transform duration-300 ${
    ...
    >
      ...
      <div className="p-6 border-b border-gray-200 flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-gray-900">My Bag ({items.length})</h2>
          <p className="text-gray-600 text-sm">Items in your shopping bag</p>
        </div>
        <button 
          onClick={onClose}
      ...
      {/* Sale Timer */}
      <div className="bg-green-100 text-green-800 p-4 flex items-center justify-center space-x-2">
      ...
      {/* Coupon Section */}
      <div className="p-4 mx-4 mt-4 bg-purple-50 border border-purple-200 rounded-lg shadow-sm">
      ...
      <div className="bg-green-600 text-white text-center p-4 rounded-t-xl">
