...
import { banners, menProducts, womenProducts, kidsProducts, cardImages } from '../assets/images';
...
function Shop() {
  ...
  const filterCategories = [
    { id: 'category', name: 'Category', count: 12, selected: 6 },
    { id: 'color', name: 'Color', count: 15, selected: 8 },
    { id: 'price', name: 'Price', count: 10, selected: 5 },
    { id: 'size', name: 'Size', count: 18, selected: 9 },
    { id: 'fit', name: 'Fit', count: 8, selected: 4 },
  ];
          ...
          <div className="w-2/3 p-4">
            <div className="space-y-4">
              {activeFilter === 'category' && (
                <>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Men (25)</span>
                  ...
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Women (30)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Kids (18)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Accessories (12)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
              {activeFilter === 'color' && (
                <>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Black (20)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">White (18)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Blue (15)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Red (12)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
              {activeFilter === 'price' && (
                <div className="space-y-4">
                  ...
                  <div className="text-lg font-medium text-[var(--text-primary)]">₹0 - ₹6000</div>
              ...
              {activeFilter === 'size' && (
                <>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">XS (8)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">S (15)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">M (20)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">L (18)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">XL (12)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
              {activeFilter === 'fit' && (
                <>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Regular (25)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Slim (18)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-[var(--text-primary)]">Loose (12)</span>
                    <input type="checkbox" className="w-4 h-4 rounded border-[var(--border-medium)] text-[var(--primary-color)] focus:ring-[var(--primary-color)]" />
                  </div>
                </>
              )}
  ...
  return (
    <div className="justify-center items-center py-4 px-4 sm:px-6 lg:px-8 bg-[var(--bg-primary)]">
      ...
      <div className="md:hidden bg-[var(--bg-primary)] border-b border-[var(--border-light)] -mx-4 -mt-4 mb-4">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="w-8 h-8 bg-[var(--success-color)] rounded-full flex items-center justify-center">
      ...
      <div className="md:hidden mb-4">
        <h1 className="text-xl font-bold text-[var(--text-primary)]">SHOP ALL PRODUCTS</h1>
      </div>
            ...
            <div className="hidden md:flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 space-y-4 sm:space-y-0">
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`p-2 rounded border border-[var(--border-light)] transition-colors ${viewMode === 'grid' ? 'bg-[var(--success-color)] text-[var(--text-inverse)]' : 'bg-[var(--bg-secondary)] text-[var(--text-primary)] hover:bg-[var(--success-color)] hover:text-[var(--text-inverse)]'}`}
                >
                  <Grid className="w-4 h-4" />
                </button>
                <button
                  onClick={() => setViewMode('list')}
                  className={`p-2 rounded border border-[var(--border-light)] transition-colors ${viewMode === 'list' ? 'bg-[var(--success-color)] text-[var(--text-inverse)]' : 'bg-[var(--bg-secondary)] text-[var(--text-primary)] hover:bg-[var(--success-color)] hover:text-[var(--text-inverse)]'}`}
                >
              ...
              <div className="flex items-center space-x-2 w-full sm:w-auto">
                ...
                <select
                  ...
                  className="text-sm border border-[var(--border-light)] rounded px-3 py-1 focus:outline-none focus:border-[var(--success-color)] w-full sm:w-auto bg-[var(--bg-primary)] text-[var(--text-primary)]"
                >
