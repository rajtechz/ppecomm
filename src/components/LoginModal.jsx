                ...
                <div className="lg:hidden">
                    ...
                    <div className="bg-gray-900 text-white p-6 relative">
                        ...
                        <div className="text-center mb-6">
                            <h3 className="text-xl font-bold mb-2">Hey Fam! Log in to join the Wrogn Tribe!</h3>
                        </div>
                    </div>

                    {/* Mobile Form */}
                    <div className="bg-white p-6">
                        <h4 className="text-lg font-bold text-gray-900 mb-4">Unlock Superior Discounts</h4>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <SendOTPButton
                                ...
                                disabled={loading || otpLoading || !acceptTerms || (otpSent ? otp.length !== 4 : mobile.length !== 10)}
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                            <div className="space-y-3">
                                <div className="bg-gray-100 rounded-lg p-3 flex items-center space-x-3">
                                    ...
                                    <span className="text-sm text-gray-700">Extra 5% OFF on prepaid payments</span>
                                </div>
                                <div className="bg-gray-100 rounded-lg p-3 flex items-center space-x-3">
                                    <Star size={16} className="text-yellow-500 flex-shrink-0" />
                                    <span className="text-sm text-gray-700">Free shipping for orders above ₹799</span>
                                </div>
                                <div className="bg-gray-100 rounded-lg p-3 flex items-center space-x-3">
                                    <Star size={16} className="text-yellow-500 flex-shrink-0" />
                                    <span className="text-sm text-gray-700">7-day stress-free return & exchange</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="hidden lg:flex">
                    ...
                    <div className="bg-gray-900 text-white p-8 w-1/2 relative">
                        ...
                        <div className="text-center mb-12">
                            <h3 className="text-2xl font-bold mb-4">Hey Fam! Log in to join the Wrogn Tribe!</h3>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-gray-800 rounded-xl p-4 flex items-center space-x-3">
                                ...
                                <span className="text-sm">Extra 5% OFF on prepaid payments</span>
                            </div>
                            <div className="bg-gray-800 rounded-xl p-4 flex items-center space-x-3">
                                <Star size={20} className="text-yellow-400 flex-shrink-0" />
                                <span className="text-sm">Free shipping for orders above ₹799</span>
                            </div>
                            <div className="bg-gray-800 rounded-xl p-4 flex items-center space-x-3">
                                <Star size={20} className="text-yellow-400 flex-shrink-0" />
                                <span className="text-sm">7-day stress-free return & exchange</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 w-1/2 relative">
                        ...
                        {/* Form Title */}
                        <h4 className="text-xl font-bold text-gray-900 mb-6">Unlock Superior Discounts</h4>
